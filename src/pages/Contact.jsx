  ...
  return (
    <section className="contact">
        ...
        <form className="contactForm" action="" onSubmit={handleSubmit}>
            ...
            <input onChange={handleChange} type="text" name="first_name" id="first_name" placeholder="Team's Name" value={contactInfo.first_name} required/>
            {window.matchMedia("(max-width:1023px)").matches &&
            <input onChange={handleChange} type="text" name="topic" id="topic" placeholder="Topic" value={contactInfo.topic}/>}
            <input onChange={handleChange} type="email" name="email" id="email" placeholder="Email" value={contactInfo.email} required/>
