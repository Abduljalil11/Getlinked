...
import designer from '../assets/images/3d-graphic-designer.png'
import bigDesigner from '../assets/images/designer-big.png'
        ...
        <form action="" className='registerForm' onSubmit={handleSubmit}>
            ...
            <div className='inputDiv'>
                ...
                <div className='block'>
                    ...
                    <input onChange={handleChange} type="text" name='project_topic' id='project_topic' placeholder='Enter your group project topic' value={application.project_topic} required/>
                </div>
                {window.matchMedia("(min-width:1024px)").matches? 
                <>
                    <div className='block'>
